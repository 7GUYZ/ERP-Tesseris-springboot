...
@Repository
public interface BusinessmanListRepository extends JpaRepository<BusinessMan, Integer> {
    @Query(value = """
        SELECT bm
        FROM BusinessMan bm
        ...
        WHERE u.userRoleIndex = 2
          ...
          AND (:businessGradeIndex IS NULL OR bg.businessGradeIndex = :businessGradeIndex)
