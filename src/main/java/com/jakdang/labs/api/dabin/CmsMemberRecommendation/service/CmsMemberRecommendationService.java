package com.jakdang.labs.api.dabin.CmsMemberRecommendation.service;
...
import com.jakdang.labs.api.dabin.CmsMemberRecommendation.repository.MemberRecommendationJdbRepo;
import com.jakdang.labs.api.dabin.CmsMemberRecommendation.repository.UserRoleJdbRepo;
...
public class CmsMemberRecommendationService {
    private final MemberRecommendationJdbRepo memberRecommendationJdbRepo;

    private final UserRoleJdbRepo userRoleJdbRepo;

    // 회원 추천현황 검색
    public List<MemberRecommendationSearchResponseDto> searchMemberRecommendations(
            MemberRecommendationSearchRequestDto dto) {
